<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="redbusIndia.index" %>
...
<link rel="dns-prefetch" href="//s2.rdbuz.com" />
<link rel="dns-prefetch" href="//s3.rdbuz.com" />
<link href="https://www.redbus.in/favicon.ico" rel="shortcut icon" />
<!--[if lt IE 9]>
<script src="https://html5shiv.googlecode.com/svn/trunk/html5.js"></script>
<![endif]-->
<meta name="Keywords" content="online bus ticket booking, bus booking, volvo ac bus booking, bus ticket booking, bus tickets" />
...
<script>    bazadebezolkohpepadr = "2072445087"</script><script type="text/javascript" src="https://www.redbus.in/akam/11/7b8703f1" defer></script></head>
    ...
    <div class="fl clearfix" id="page_main_header">
        <nav class="product-nav fl">
            <ul>
                            ...
                            <li><a href="rpool.aspx" title="cars" class="site-links rpool_title" id="cars">rPool <sup style='font-weight: bold;'>New</sup> </a></li>
                    ...
                    <div class="fr config-div" tabindex="0" id="select_box_sign">
                        <div id="signin_dd">
                            <div class="fr signin-block" id="signin-block">
                                ...
                                <div id="sign-in-icon-down" class="icon ich dib icon-down_WO_BAL">                                
...
<section class="head-banner">
    <div class="banner-wrapper">
            <div id="image_div">
                <div id="welcome_image_div" style="background-image: url('https://st.redbus.in/Images/INDOFFER/COVID-19/heroimage2.png')">
                </div>
            </div>
...
<section id="search">
    <div class="clearfix search-wrap">
        <div class="fl search-box clearfix">
            ...
            <div>
                <input type="text" id="src" class="db" data-message="Please enter a source city" tabindex="1" autocomplete="on" />
        ...
        <div class="fl search-box">
            ...
            <div>
                <input type="text" id="dest" class="db" data-message="Please enter a destination city" tabindex="2"  autocomplete="on"/>
        ...
        <asp:button runat="server" id="search_btn" class="fl button" 
            Text="Search Buses" onclick="search_btn_Click"></asp:button>
    </div>
</section>
        ...
        <div id="offer_div" class="rest1 offer_div ">
            <div class="main-body over-vis">
                <div class="w-100" id="gtm_promo_cont">
                            ...
                            <div class="clearfix dib promotions-wrap link-blocks gtm-promotions-trigger" data-link="" data-slot="1" data-creative="promotion-banner">
                                <div class="fl dib promotion-image">
                                    <img src=https://st.redbus.in/Images/INDOFFER/Center100X100.png />
                                </div>
                
                                <div class="fl dib promotion-text-wrap">
                                    <div class="tac promotion-header main-header-family gtm-offer-code">
                                        This Festive Season, Harvest Happiness!
                                    </div>
                                    <div class="tac promotion-description gtm-offer-desc">
                                        Book your bus ticket home and reap celebrations with your loved ones!
                                    </div>
                                </div>
                            </div>
                            </div>
            ...
            <div data-order=3>
                <div class="clearfix dib safety-plus-tile">
                    <div class="sp-container">
                        <div><img src="https://s3.rdbuz.com/Images/webplatform/measures/safetyplus.svg" alt="" width="60" height="70" /></div>
                        <div class="sp-info">
                            <div>Introducing Safety&#x2B; Program</div>
                            <div class="sp-i-msg">A unique certification program to ensure safety in all buses.</div>
                        </div>
                        <div class="button-comp-cont">
                            <div id="safetyplusClick" class="bc">Know More</div>
                        </div>
                    </div>
                </div>
            </div> 
                ...
                <div class="w-100" id="gtm_promo_cont">
                    ...
                    <div id="carousel-wrapper" class="carousel-wrapper clearfix  w-1155">
                    <!-- <div class="offers-slide-block" id="offers_slide_block"> -->
                        ...
                        <!-- <ul class="offers-slide-list"> -->
                                        <li class="  offer-slide-item offer-blocks gtm-promotions-trigger grow" data-link="https://www.redbus.in/info/OfferTerms#FIRST" data-slot=1 data-creative="offer-banner" style="width:360px !important">
                                        <span class="clearfix offer-li-wrap">
                                            <span class="offer-det">
                                                Save up to Rs 150 on bus tickets
                                            </span>
                                            <span class="offer-img">
                                                <img src=https://st.redbus.in/Images/INDOFFER/safetyplus/274_147.png />
                                            </span>
                                        ...
                                        <li class="  offer-slide-item offer-blocks gtm-promotions-trigger grow" data-link="https://www.redbus.in/info/OfferTerms#AMAZON" data-slot=2 data-creative="offer-banner" style="width:360px !important">
                                        <span class="clearfix offer-li-wrap">
                                            <span class="offer-det">
                                        ...
                                        <li class="  offer-slide-item offer-blocks gtm-promotions-trigger grow" data-link="https://www.redbus.in/info/OfferTerms#APSRTC" data-slot=3 data-creative="offer-banner" style="width:360px !important">
                                        <span class="clearfix offer-li-wrap">
                                            <span class="offer-det">
                                                No Coupon Code Required
                                            </span>
                                            <span class="offer-img">
                                                <img src=https://st.redbus.in/Images/APSRTC/new/APSRTC_1.png />
                                            </span>
                                            <span class="fl w-100 offer-txt-wraper">
                                                <span class="offer-code gtm-offer-code">
                                                    Get 10% off on APSRTC Buses
                                                </span>
...
<div class="main-body">
  <div class="HeroMain">
    <div class="header">
        <div class="img2_Hero"></div>
           
              <span class="fl">
              <div class="Title_hero">Introducing Safety&#x2B;</div>
              <div class="subtext_hero">
                Opt to Travel Safe with redBus
                    <a class="know-more-anchor" href="/SafetyPlus">&nbsp;Know more</a>
              </div>
              </span>
              <span class="fr">
             </span>             
        ...
        <section class="pR">
            <div class="clearfix op-wrapper">
                <div class="pA w-50 txt-otherplt">
                    ...
                    <div class="desc-OP-new rest1"> Exclusive features on mobile include <br/><span class='Platform-hl'>redBus NOW</span> - when you need a bus in the next couple of hours. Board a bus on its way. <br/><span class='Platform-hl'>Boarding   Point Navigation</span> -  Never lose your way while travelling to your boarding point! <br/><span class='Platform-hl'>1-click Booking </span>- Save your favourite payment options securely on redBus, and more.<br/><span class='Platform-hl'> Download the app.</span></div>
            ...
            <div class="clearfix stats-v-holder">
                <div class="fl">
                    <div>
                        ...
                        <div class="sv rest1">23 M</div>
                        <div class="common-desc second-level-heading rest1">redBus is trusted by over 23 million happy customers globally</div>
                    </div>
                </div>
                <div class="fl">
                    <div>
                        <div class="sp rest1">OPERATORS</div>
                        <div class="sv rest1">2600</div>
                        <div class="common-desc second-level-heading rest1">network of over 2600 bus operators worldwide</div>
                    </div>
                </div>
                <div class="fl">
                    <div>
                        <div class="sp rest1">BUS TICKETS</div>
                        <div class="sv rest1">180&#x2B; M</div>
                        <div class="common-desc second-level-heading rest1">Over 180 million trips booked using redBus</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class='w-20 fl tac fl tal'>
            <div class="seo-header">
                Top RTC&#x27;s
                 ...
                 <a href='/online-booking/hrtc.aspx'  target="_blank" title="HRTC">HRTC</a>
                 <a href='/online-booking/upsrtc.aspx'  target="_blank" title="UPSRTC">UPSRTC</a>
        ...
        <div class='w-20 fl tac fl tal'>
            <div class="seo-header">
                Other
                 ...
                 <a href='https://www.redbus.in/online-booking/gsrtc.aspx'  target="_blank" title="GSRTC">GSRTC</a>
                 <a href='https://www.redbus.in/online-booking/rsrtc.aspx'  target="_blank" title="RSRTC">RSRTC</a>
                 <a href='https://www.redbus.in/online-booking/ktcl.aspx'  target="_blank" title="KTCL">KTCL</a>
                 <a href='https://www.redbus.in/online-booking/pepsu.aspx'  target="_blank" title="PEPSU">PEPSU</a>
...
<div class="footer-row">
    ...
    <script>
        ...
        var countryspecificdate = '2021/03/04';
    ...
    <script src="layout.js" type="text/javascript"></script>    
     ...
     <script type="text/javascript">
         ...
         var IS_SAFETY_PLUS_TILE_ENABLED = true;
         var safetyPlusTile = { "title": "Introducing Safety+ Program", "image": "https://s3.rdbuz.com/Images/webplatform/measures/safetyplus.svg", "msg": "A unique certification program to ensure safety in all buses.", "btnLabel": "Know More", "btnUrl": "/SafetyPlus" };
...
<noscript><img src="https://www.redbus.in"pic1.png"" style="visibility: hidden; position: absolute; left: -999px; top: -999px;" /></noscript>
